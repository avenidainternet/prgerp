							...
							<td>
								...
								if($rowFac[Estado]=='P' and $nDias <= 2){ // Enviada
									...
									if($nDias <= 0){ // En Proceso
										$scr = 'roja';
										echo '<img src="http://simet.cl/erp/imagenes/bola_roja.png">';
									}else{
										echo '<img src="http://simet.cl/erp/imagenes/bola_amarilla.png">';
									}
								}else{
									if($rowFac[Estado] == 'P'){ // Aceptada
										$scr = 'verde';
										echo '<img src="http://simet.cl/erp/imagenes/bola_verde.png">';
									}
								}
								?>
							</td>
				...
				if ($rowFac=mysql_fetch_array($bdFac)){
					do{ 
						...
						if($rowFac[situacionMuestra]=='B'){
							if($rowFac[CAM]>0){
								$tr = "#009966"; // Verde
								$scr = 	"http://simet.cl/erp/imagenes/bola_verde.png";
							}else{
								$tr = "#0099CC"; // Azul
								$scr = 	"http://simet.cl/erp/imagenes/bola_azul.png";
							}
						}
						if($rowFac[situacionMuestra]=='R'){
							$tr = "#FF0000"; // Roja
							$scr = 	"http://simet.cl/erp/imagenes/bola_roja.png";
						}
