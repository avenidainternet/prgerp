...
include_once("conexionli.php");
	...
	if(isset($_GET['periodo'])) 		{	$periodo 	= $_GET['periodo']; 		}
				...
				$filtro = " year(fechaFactura) = '$ageCpra'";
				if(isset($IdProyecto)){
					$filtro .= " and IdProyecto = '$IdProyecto' ";
				}
				if(isset($mesCpra)){
					$filtro .= " and month(fechaFactura) = '$mesCpra' ";
				}

				$SQL = "SELECT * FROM solfactura Where $filtro Order By fechaFactura Asc";
