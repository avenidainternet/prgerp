...
<form name="form" action="edicionInformes.php" method="post">
		...
		<table width="99%"  border="0" cellpadding="0" cellspacing="0" id="cajaDeTexto">
			<tr>
				<td>
					...
					mysql_close($link);
					$txtItemA = 'A.- Identificaci�n de la Muestra';
					if($Mu[1]>1){
						$txtItemA = 'A.- Identificaci�n de las Muestras';
					}
		...
		<table width="100%" cellpadding="0" cellspacing="0" id="tablaIdMuestras">
			<tr bgcolor="#CCCCCC">
				<td align="center">C�digo de Verificaci�n</td>
				<td align="center">C�digo QR</td>
			</tr>
			<tr>
				<td align="center">
				...
				<td align="center">
					...
					<?php
						if($imgQR){
							$dirImg = "http://simet.cl/erp/codigoqr/phpqrcode/temp/$imgQR";
