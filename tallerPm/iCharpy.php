<?php
	...
	$link=Conectarse();
	$bd=$link->query("Select * From otams Where Otam = '$Otam'");
				...
				<div class="col">
					<div class="contenedor d-md-flex">
						<div class="col">
							Descripción
							<div class="contenedor d-md-flex">
								<div class="col">Fecha Ensayo<br>
									<input class="form-control" type="date" ng-model="fechaRegistro" tabindex="1" ng-change="cambiaFecha()">
								</div>
								<div class="col">Equipo<br>
								<!-- <div class="col"> -->
									<select class="form-control" ng-model="Equipo" ng-change="guardarRegEquipo(Equipo)">
        								<option value="Imp-01">Imp-01</option>
        								<option value="Imp-02">Imp-02</option>
    								</select>
								</div>

								<div class="col">Tº Ens.<br>
								<!-- <div class="col"> -->
									<input class="form-control" type="text" tabindex="2" ng-model="Tem" ng-change="cambiaTem()">
								</div>
								<div class="col">Tº Amb.<br>
								<!-- <div class="col"> -->
									<input class="form-control" type="text" tabindex="3" ng-model="TemAmb" ng-change="cambiaTemAmb()">
								</div>
								<div class="col">% Hum.<br>
								<!-- <div class="col"> -->
									<input class="form-control" type="text" tabindex="4" ng-model="Hum" ng-change="cambiaHum()">
								</div>
							</div>
						</div>
						<div class="col">
							...
							<div class="contenedor d-md-flex">
								<div class="col">TpEnsayo<br>
								<!-- <div class="col"> -->
									<input class="form-control" type="text" ng-model="tpMuestra" readonly>
								</div>
								<div class="col">Impactos<br>
								<!-- <div class="col"> -->
									<input class="form-control" type="text" ng-model="nImpacto" readonly >
								</div>
								<div class="col">Entalle<br>
								<!-- <div class="col"> -->
								...
								<table class="table table-dark table-hover table-bordered">
									...
									<tbody class="table-striped">
										...
										<tr class="table-primary text-center" ng-repeat="x in dataImpactos">
											...
											<td>												
												<input tabindex="{{$index + 6}}" type="text" maxlength="5" size="5"  ng-model="x.Ancho"   ng-change="guardarRegAnc(x.Ancho, x.nImpacto)" ng-blur="refrescarDatos()">
											</td>
											<td>
												<input tabindex="{{$index + 6}}" type="text" maxlength="5" size="5" ng-model="x.Alto"   ng-change="guardarRegAlt(x.Alto, x.nImpacto)" ng-blur="refrescarDatos()">
											</td>
											<td>
												<!-- <input tabindex="{{$index + 6}}" type="text" maxlength="5" size="5" ng-model="x.resEquipo"   ng-change="guardarRegEqui(x.resEquipo, x.nImpacto)" ng-blur="recargarPagina()"> -->
