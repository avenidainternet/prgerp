...
<body>
		...
		<table border="1" cellpadding="0" cellspacing="0">
			...
			<tr>
				<td colspan=9 height="30" style="color:#FFFFFF; background-color:#006699; font-size:18px;">Solicitudes Facturadas</td>
			</tr>
			<tr style="font-weight:700; font-size:12px;" height="25">
  			...
  			<?php
				...
				$bdFac=$link->query("SELECT * FROM SolFactura Where fechaSolicitud >= '2020-01-01' and fechaSolicitud <=  '2025-10-30' Order By fechaSolicitud Asc");
